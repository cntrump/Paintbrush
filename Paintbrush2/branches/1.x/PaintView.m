...
{		
	...
	// Useful for transparency: paints a color instead of just puking all over the screen
	[backColor set];	
	[NSBezierPath fillRect:[self bounds]];
...
- (void)mouseDown:(NSEvent *)event
{
	...
	if (currentTool != [[ToolboxController sharedToolboxPanelController] currentTool]) {
...
{	
	// Instead of replacing the image, here we're drawing over the old one
	[mainImage lockFocus];
	[[NSGraphicsContext currentContext] setImageInterpolation:NSImageInterpolationNone];
